...
class ReviewsController::RoutesTest < ActionController::TestCase
  def test_user_review_routes
    assert_routing '/users/1/reviews', controller: 'reviews', action: 'index', user_id: '1', locale: nil
    ...
    # assert_routing '/users/1/reviews/1/update', controller: 'reviews', action: 'update_review', id: '1'
    # assert_routing '/users/1/reviews/1/destroy', controller: 'reviews', action: 'destroy_review', id: '1
  end
end
