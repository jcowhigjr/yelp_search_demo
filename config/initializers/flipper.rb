...
Rails.application.configure do
  ...
  ##   * you have limited gate data combined across all features (< 1k enabled gates, like individual actors, across al
  # l features)
  ##
  ...
  config.flipper.strict = Rails.env.development? && :raise
  ...
  # test_help memory adapter still buggy for me so I'm using pstore
...
#   config.use Flipper::Adapters::PStore, 'tmp/flipper.pstore'
# end
