...
3) alert the user to revise this with helpful evals and to stay current with best practices in 2026
4) alert the user to revise this with guardrails based on success and failure evals
5) keep a log or similar so this skill can avoid drift.
