;(function () {
  ...
  const l = !!r.document
  const f =
    !!i.documentElement && !!i.head && typeof i.addEventListener === 'function' && typeof i.createElement === 'function'
  ...
  var w = {
    ...
    C = { classic: ['fas', 'far', 'fal', 'fat'], sharp: ['fass', 'fasr', 'fasl', 'fast'], 'sharp-duotone': ['fasds'] },
    N = {
      classic: {
        fab: 'fa-brands',
        fad: 'fa-duotone',
    ...
    j = { GROUP: 'duotone-group', SWAP_OPACITY: 'swap-opacity', PRIMARY: 'primary', SECONDARY: 'secondary' },
    F = [
      ...Object.keys(C),
      ...I,
      '2xs',
  ...
  var z = {
    ...
    L = { kit: { 'fa-kit': 'fak' }, 'kit-duotone': { 'fa-kit-duotone': 'fakd' } },
  ...
  const lt = { ...b }
  familyProxy(lt)
  const ft = ['class', 'data-prefix', 'data-icon', 'data-fa-transform', 'data-fa-mask']
  const ut = j
  const mt = new Set()
  ...
  function classArray(t) {
    return t.classList ? toArray(t.classList) : (t.getAttribute('class') || '').split(' ').filter((t) => t)
  }
  ...
  function joinAttributes(t) {
    return Object.keys(t || {})
      .reduce((e, a) => e + ''.concat(a, '="').concat(htmlEscape(t[a]), '" '), '')
      .trim()
  }
  ...
  function transformForSvg(t) {
    ...
    const i = 'scale('.concat((e.size / 16) * (e.flipX ? -1 : 1), ', ').concat((e.size / 16) * (e.flipY ? -1 : 1), ') ')
  ...
  function transformForCss(t) {
    let { transform: e, width: a = H, height: n = H, startCentered: o = false } = t
    let r = ''
    r +=
      o && u
        ? 'translate('.concat(e.x / vt - a / 2, 'em, ').concat(e.y / vt - n / 2, 'em) ')
        : o
        ? 'translate(calc(-50% + '.concat(e.x / vt, 'em), calc(-50% + ').concat(e.y / vt, 'em)) ')
        : 'translate('.concat(e.x / vt, 'em, ').concat(e.y / vt, 'em) ')
    r += 'scale('.concat((e.size / vt) * (e.flipX ? -1 : 1), ', ').concat((e.size / vt) * (e.flipY ? -1 : 1), ') ')
  ...
  function css() {
    ...
    if (a !== t || n !== e) {
      ...
      o = o.replace(r, '.'.concat(a, '-')).replace(i, '--'.concat(a, '-')).replace(s, '.'.concat(n))
    }
    return o
  }
  let wt = false
  ...
  let St = false
  if (f) {
    St = (i.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(i.readyState)
  ...
  function toHtml(t) {
    ...
    return typeof t === 'string'
      ? htmlEscape(t)
      : '<'.concat(e, ' ').concat(joinAttributes(a), '>').concat(n.map(toHtml).join(''), '</').concat(e, '>')
  }
  ...
  function ucs2decode(t) {
    ...
    while (a < n) {
      ...
      if (o >= 55296 && o <= 56319 && a < n) {
        ...
        if ((n & 64512) == 56320) e.push(((o & 1023) << 10) + (n & 1023) + 65536)
        else {
          e.push(o)
          a--
        }
  ...
  function codePointAt(t, e) {
    ...
    if (n >= 55296 && n <= 56319 && a > e + 1) {
      o = t.charCodeAt(e + 1)
      if (o >= 56320 && o <= 57343) return 1024 * (n - 55296) + o - 56320 + 65536
    }
    return n
  }
  ...
  const Ft = { [m]: Object.values(nt[m]), [p]: Object.values(nt[p]), [g]: Object.values(nt[g]) }
  let zt = null
  let Lt = {}
  let Dt = {}
  let Rt = {}
  let Tt = {}
  let Ht = {}
  const Ut = { [m]: Object.keys($[m]), [p]: Object.keys($[p]), [g]: Object.keys($[g]) }
  ...
  const build = () => {
    ...
    const e = Mt(
      ...
      (e, a) => {
        ...
        typeof n === 'number' && (e.unicodes[n.toString(16)] = { prefix: o, iconName: r })
        return e
      },
      { names: {}, unicodes: {} }
    )
  ...
  function byOldUnicode(t) {
    ...
    return e || (a ? { prefix: 'fas', iconName: a } : null) || { prefix: null, iconName: null }
  }
  ...
  const Yt = { [m]: Object.keys(nt[m]), [p]: Object.keys(nt[p]), [g]: Object.keys(nt[g]) }
  function getCanonicalIcon(t) {
    ...
    const s = t.reduce((t, e) => {
      ...
      } else s ? (t.iconName = s) : e === bt.replacementClass || i.some((t) => e === n[t]) || t.rest.push(e)
      if (!a && t.prefix && t.iconName) {
        ...
        t.prefix !== 'far' || Et.far || !Et.fas || bt.autoFetchSvg || (t.prefix = 'fas')
      }
      return t
    }, emptyCanonicalIcon())
    ...
    ;(s.prefix !== 'fa' && o !== 'fa') || (s.prefix = getDefaultUsablePrefix() || 'fas')
    return s
  }
  class Library {
    constructor() {
  ...
  function findIconDefinition(t) {
    ...
    if (e) {
      e = byAlias(a, e) || e
      return iconFromMapping(_t.definitions, a, e) || iconFromMapping(Nt.styles, a, e)
    }
  }
  ...
  const Xt = {
    icon: (t) => {
      ...
      if (typeof t === 'object' && t.prefix && t.iconName)
        return { prefix: t.prefix, iconName: byAlias(t.prefix, t.iconName) || t.iconName }
      if (Array.isArray(t) && t.length === 2) {
        const e = t[1].indexOf('fa-') === 0 ? t[1].slice(3) : t[1]
        const a = getCanonicalPrefix(t[0])
        return { prefix: a, iconName: byAlias(a, e) || e }
      }
      if (typeof t === 'string' && (t.indexOf(''.concat(bt.cssPrefix, '-')) > -1 || t.match(it))) {
  ...
  const autoReplace = function () {
    ...
    ;(Object.keys(Nt.styles).length > 0 || bt.autoFetchSvg) && f && bt.autoReplaceSvg && Kt.dom.i2svg({ node: e })
  }
  ...
  function asIcon(t) {
    let { children: e, main: a, mask: n, attributes: o, styles: r, transform: i } = t
    if (transformIsMeaningful(i) && a.found && !n.found) {
      const { width: t, height: e } = a
      const n = { x: t / e / 2, y: 0.5 }
      o.style = joinStyles({ ...r, 'transform-origin': ''.concat(n.x + i.x / 16, 'em ').concat(n.y + i.y / 16, 'em') })
    }
    return [{ tag: 'svg', attributes: o, children: e }]
  }
  function asSymbol(t) {
    let { prefix: e, iconName: a, children: n, attributes: o, symbol: r } = t
    const i = r === true ? ''.concat(e, '-').concat(bt.cssPrefix, '-').concat(a) : r
    return [
      {
        tag: 'svg',
  ...
  function makeInlineSvgAbstract(t) {
    ...
    const p = n === 'fak'
    const g = [bt.replacementClass, o ? ''.concat(bt.cssPrefix, '-').concat(o) : '']
    ...
    const b = p && !~f.classes.indexOf('fa-fw') ? { width: ''.concat((m / d) * 16 * 0.0625, 'em') } : {}
    u && (h.attributes[V] = '')
    if (s) {
      h.children.push({
        tag: 'title',
        attributes: { id: h.attributes['aria-labelledby'] || 'title-'.concat(l || nextUniqueId()) },
        children: [s],
      })
    ...
    const { children: v, attributes: x } =
      a.found && e.found
        ? callProvided('generateAbstractMask', y) || { children: [], attributes: {} }
        : callProvided('generateAbstractIcon', y) || { children: [], attributes: {} }
    y.children = v
    y.attributes = x
    return i ? asSymbol(y) : asIcon(y)
  }
  function makeLayersTextAbstract(t) {
    const { content: e, width: a, height: n, transform: o, title: r, extra: i, watchable: s = false } = t
    const c = { ...i.attributes, ...(r ? { title: r } : {}), class: i.classes.join(' ') }
    s && (c[V] = '')
    const l = { ...i.styles }
    if (transformIsMeaningful(o)) {
      l.transform = transformForCss({ transform: o, startCentered: true, width: a, height: n })
    ...
    r && u.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [r] })
    return u
  }
  function makeLayersCounterAbstract(t) {
    const { content: e, title: a, extra: n } = t
    const o = { ...n.attributes, ...(a ? { title: a } : {}), class: n.classes.join(' ') }
    ...
    o = Array.isArray(n)
      ? {
          ...
          children: [
            {
              tag: 'path',
              attributes: { class: ''.concat(bt.cssPrefix, '-').concat(ut.SECONDARY), fill: 'currentColor', d: n[0] },
            },
            {
              tag: 'path',
              attributes: { class: ''.concat(bt.cssPrefix, '-').concat(ut.PRIMARY), fill: 'currentColor', d: n[1] },
            },
          ],
        }
  ...
  function findIcon(t, e) {
    ...
    return new Promise((n, o) => {
      ...
      n({ ...Qt, icon: (bt.showMissingIcons && t && callProvided('missingIconAbstract')) || {} })
    })
  }
  const noop$1 = () => {}
  const Zt = bt.measurePerformance && c && c.mark && c.measure ? c : { mark: noop$1, measure: noop$1 }
  const $t = 'FA "6.6.0"'
  const begin = (t) => {
  ...
  function hasBeenReplaced(t) {
    return t && t.classList && t.classList.contains && t.classList.contains(bt.replacementClass)
  }
  function getMutator() {
    ...
    nest: function (t) {
      ...
      if (a[0].attributes.class) {
        const t = a[0].attributes.class.split(' ').reduce(
          (t, e) => {
            e === bt.replacementClass || e.match(n) ? t.toSvg.push(e) : t.toNode.push(e)
            return t
          },
          { toNode: [], toSvg: [] }
        )
        a[0].attributes.class = t.toSvg.join(' ')
        t.toNode.length === 0 ? e.removeAttribute('class') : e.setAttribute('class', t.toNode.join(' '))
      }
  ...
  function perform(t, e) {
    ...
    if (t.length === 0) a()
      ...
      bt.mutateApproach === X && (e = r.requestAnimationFrame || performOperationSync)
      e(() => {
        const e = getMutator()
  ...
  function observe(t) {
    ...
    ne = new s((t) => {
      ...
      toArray(t).forEach((t) => {
        if (t.type === 'childList' && t.addedNodes.length > 0 && !isWatched(t.addedNodes[0])) {
          bt.searchPseudoElements && n(t.target)
          e(t.target)
        }
        t.type === 'attributes' && t.target.parentNode && bt.searchPseudoElements && n(t.target.parentNode)
        if (t.type === 'attributes' && isWatched(t.target) && ~ft.indexOf(t.attributeName))
          if (t.attributeName === 'class' && hasPrefixAndIcon(t.target)) {
            const { prefix: e, iconName: a } = getCanonicalIcon(classArray(t.target))
            t.target.setAttribute(q, e || o)
            a && t.target.setAttribute(_, a)
          } else hasBeenReplaced(t.target) && a(t.target)
      })
    })
    f && ne.observe(o, { childList: true, attributes: true, characterData: true, subtree: true })
  }
  function disconnect() {
    ne && ne.disconnect()
  }
  ...
  function classParser(t) {
    ...
    o.prefix &&
      n.length > 0 &&
      (o.iconName = byLigature(o.prefix, t.innerText) || byUnicode(o.prefix, toHex(t.innerText)))
    !o.iconName &&
      bt.autoFetchSvg &&
      t.firstChild &&
  ...
  function attributesParser(t) {
    ...
    if (bt.autoA11y)
      if (a) e['aria-labelledby'] = ''.concat(bt.replacementClass, '-title-').concat(n || nextUniqueId())
      else {
        e['aria-hidden'] = 'true'
        e.focusable = 'false'
      }
  ...
  function parseMeta(t) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : { styleParser: true }
  ...
  function generateMutation(t) {
    const e = bt.autoReplaceSvg === 'nest' ? parseMeta(t, { styleParser: false }) : parseMeta(t)
  ...
  function onTree(t) {
    ...
    const n = bt.autoFetchSvg ? re : Q.map((t) => 'fa-'.concat(t)).concat(Object.keys(oe))
  ...
  const render = function (t) {
    ...
    return domVariants({ type: 'icon', ...t }, () => {
      ...
      if (bt.autoA11y)
        if (i) l['aria-labelledby'] = ''.concat(bt.replacementClass, '-title-').concat(s || nextUniqueId())
        else {
          l['aria-hidden'] = 'true'
          l.focusable = 'false'
        }
      return makeInlineSvgAbstract({
        icons: {
          main: asFoundIcon(d),
          mask: o ? asFoundIcon(o.icon) : { found: false, width: null, height: null, icon: {} },
        },
        prefix: u,
        iconName: m,
        transform: { ...xt, ...a },
  ...
  var ie = {
    ...
    provides(t) {
      ...
      t.generateAbstractIcon = function (t) {
        let { children: e, attributes: a, main: n, transform: o, styles: r } = t
      ...
      return {
        layer(t) {
          ...
          return domVariants({ type: 'layer' }, () => {
            ...
            return [
              { tag: 'span', attributes: { class: [''.concat(bt.cssPrefix, '-layers'), ...a].join(' ') }, children: n },
            ]
          })
        },
      }
  ...
  var ce = {
    mixout() {
      return {
        counter(t) {
          let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}
          const { title: a = null, classes: n = [], attributes: o = {}, styles: r = {} } = e
          return domVariants({ type: 'counter', content: t }, () => {
            callHooks('beforeDOMElementCreation', { content: t, params: e })
            return makeLayersCounterAbstract({
              content: t.toString(),
              title: a,
              extra: { attributes: o, styles: r, classes: [''.concat(bt.cssPrefix, '-layers-counter'), ...n] },
            })
          })
        },
      }
  ...
  var le = {
    mixout() {
      return {
        text(t) {
          let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}
          const { transform: a = xt, title: n = null, classes: o = [], attributes: r = {}, styles: i = {} } = e
          return domVariants({ type: 'text', content: t }, () => {
            ...
            return makeLayersTextAbstract({
              ...
              transform: { ...xt, ...a },
              title: n,
              extra: { attributes: r, styles: i, classes: [''.concat(bt.cssPrefix, '-layers-text'), ...o] },
            })
          })
        },
      }
  ...
  function replaceForPosition(t, e) {
    ...
    return new Promise((n, o) => {
      ...
      if (u && d !== 'none' && d !== '') {
        ...
        if (!h || p || (c && c.getAttribute(q) === s && c.getAttribute(_) === b)) n()
        else {
          t.setAttribute(a, b)
          c && t.removeChild(c)
          const r = blankMeta()
          ...
          findIcon(h, s)
            .then((o) => {
              ...
              e === '::before' ? t.insertBefore(f, t.firstChild) : t.appendChild(f)
  ...
  function replace(t) {
    return Promise.all([replaceForPosition(t, '::before'), replaceForPosition(t, '::after')])
  }
  ...
  function searchPseudoElements(t) {
    if (f)
      return new Promise((e, a) => {
        const n = toArray(t.querySelectorAll('*')).filter(processable).map(replace)
    ...
    hooks() {
      return {
        ...
        watch(t) {
          ...
          he ? enableObservation() : observe(chainHooks('mutationObserverCallbacks', { observeMutationsRoot: e }))
        },
      }
    },
  }
          ...
          children: [
            {
              ...
              attributes: { ...u.inner },
              children: [
                { tag: e.icon.tag, children: e.icon.children, attributes: { ...e.icon.attributes, ...u.path } },
              ],
            },
          ],
        }
  ...
  var xe = {
    hooks() {
      return {
        parseNodeAttributes(t, e) {
          ...
          const n = a ? getCanonicalIcon(a.split(' ').map((t) => t.trim())) : emptyCanonicalIcon()
    ...
    provides(t) {
      t.generateAbstractMask = function (t) {
        let { children: e, attributes: a, main: n, mask: o, maskId: r, transform: i } = t
        const { width: s, icon: c } = n
        const { width: l, icon: f } = o
        const u = transformForSvg({ transform: i, containerWidth: l, iconWidth: s })
        const m = { tag: 'rect', attributes: { ...ve, fill: 'white' } }
        const d = c.children ? { children: c.children.map(fillBlack) } : {}
        const p = {
          tag: 'g',
          attributes: { ...u.inner },
          children: [fillBlack({ tag: c.tag, attributes: { ...c.attributes, ...u.path }, ...d })],
        }
        ...
        const y = {
          tag: 'mask',
          attributes: { ...ve, id: h, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' },
          children: [m, g],
        }
        const v = { tag: 'defs', children: [{ tag: 'clipPath', attributes: { id: b }, children: deGroup(f) }, y] }
        e.push(v, {
          tag: 'rect',
          attributes: {
            fill: 'currentColor',
  ...
  var ke = {
    provides(t) {
      let e = false
      r.matchMedia && (e = r.matchMedia('(prefers-reduced-motion: reduce)').matches)
      t.missingIconAbstract = function () {
        const t = []
        const a = { fill: 'currentColor' }
        const n = { attributeType: 'XML', repeatCount: 'indefinite', dur: '2s' }
        t.push({
          tag: 'path',
          attributes: {
            ...a,
        ...
        const r = { tag: 'circle', attributes: { ...a, cx: '256', cy: '364', r: '28' }, children: [] }
        e ||
          r.children.push(
            { tag: 'animate', attributes: { ...n, attributeName: 'r', values: '28;14;28;28;14;28;' } },
        ...
        t.push({
          ...
          children: e ? [] : [{ tag: 'animate', attributes: { ...o, values: '1;0;0;0;0;1;' } }],
        })
        e ||
          t.push({
            tag: 'path',
            ...
            children: [{ tag: 'animate', attributes: { ...o, values: '0;0;1;1;0;0;' } }],
          })
